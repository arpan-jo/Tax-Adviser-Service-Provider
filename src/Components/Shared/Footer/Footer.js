            ...
            <div className="row">
               <div className="col-md-4 mt-4 mb-3">
                  ...
                  <small className="text-secondary">
                     ...
                     Optio enim aut suscipit corporis, inventore sint non
                     explicabo fugiat sapiente quae?
                  </small>
                  <br />
                  <small className="text-secondary">
                     <FontAwesomeIcon icon={faHome} /> 545, Great Lane, New
                     York, US
                  </small>
                  <br />
                  <small className="text-secondary">
               ...
               <div className="col-md-4 mt-4 mb-3">
                  ...
                  <div>
                     ...
                     <small className="text-secondary">
                        ...
                        elit. Sapiente reprehenderit nulla fugiat commodi.
                     </small>
                     <br />
